...
<div class="modal modif-projet" id="modifProjectModal">
   <div class="modal-content form-mod">
      ...
      <form class="projet" method="POST" action="./modal/modif-projet.php" data-reload>
         ...
         <div class="general">
            <input type="text" name="titre" id="titre" class="boite" required required value="<?= $fetch_projects['titre']; ?>">
            <input type="text" name="type1" id="type1" class="boite" required required value="<?= $fetch_projects['type1']; ?>">
            <div id="duree-total">
         ...
         <div id="sections-container">
            ...
            <section class="section">
               ...
               <?php if(isset($fetch_projects['short_synopsis']) && $fetch_projects['short_synopsis'] !== ''){ ?>
                  ...
                  <button class="modaleBtn hidden" type="button" onclick="shortSynopsis()" id="shortSB">Ajouter un synopsis court</button>
            ...
            <section class="section">
               ...
               <div id="resume-container">
                  ...
                  <button class="modaleBtn hidden" type="button" onclick="shortVueEnsemble()" id="shortRB">Ajouter un résumé court</button>
